...
and downloaded the report generated by PMD to identify the issues. In the report I found 2 issues that included import issues from `ProductController.java` and unnecessary `public` modifiers from `ProductService.java`. I started fixing 
